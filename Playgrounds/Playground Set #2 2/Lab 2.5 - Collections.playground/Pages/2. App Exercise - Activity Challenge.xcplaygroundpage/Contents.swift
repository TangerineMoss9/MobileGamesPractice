 ...
 */
var wChallenge: [String] = ["mile", "3 mile"]
var rChallenge: [String] = ["5 mile", "10 mile"]
/*:
 ...
 */
var challenges = [wChallenge,rChallenge]
...
if commit.isEmpty{
    ...
    print("The challenge you have chosen is \(commit)")
}else{
