...
var favoriteBook = Book(title: "A book", author: "An author", pages: 100, price: 29.99)
print(favoriteBook)
/*:
...
struct Height{
    ...
    var heightInCetimeters:Double
    
    init(inches: Double){
        heightInInches = inches
        heightInCetimeters = inches*2.54
    }
    init(centimeters: Double){
        heightInInches = centimeters/2.54
        heightInCetimeters = centimeters
    }
