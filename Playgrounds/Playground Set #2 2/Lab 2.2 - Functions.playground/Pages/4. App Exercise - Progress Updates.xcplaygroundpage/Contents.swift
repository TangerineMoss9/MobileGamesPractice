...
func progressUpdate(steps: Int, goal: Int){
    ...
    else if (steps < goal/2 && steps > goal/10){
        print("You're almost halfway there!")
    }
    else if (steps > goal/2 && Double(steps) < Double(goal)*0.9){
        print("You're over halfway there!")
    }
    else if (steps < goal && Double(steps) > Double(goal)*0.9){
...
progressUpdate(steps: 123, goal: 250)
progressUpdate(steps: 223, goal: 250)
progressUpdate(steps: 300, goal: 250)
/*:
