...
let nameInCaps = "Zach"
let name = "zach"
name == nameInCaps ? print("The two strings are equal"):print("The two strings are not equal.")
/*:
 ...
 */
name.lowercased() == nameInCaps.lowercased() ? print("\(nameInCaps.lowercased()) and \(name.lowercased()) are the same."):print("\(nameInCaps.lowercased()) and \(name.lowercased()) are not the same.")
...
junior.hasSuffix("Jr.") ? print("We found a second generation name!") : print("No second generation name!")
/*:
...
textToSearchThrough.lowercased().contains(textToSearchFor) ? print("I found it!") : print("Not found.")
